                                ...
                                <div class="row-fluid">
                                    <div class="span2">
                                        <div class="img-holder">
                                            <img class="img-avatar" alt="" src="/PGCL_WEB/resources/images/taka.png">
                                        </div>
                                    </div>
                                    <div class="span10">
                                        ...
                                        <img src="/PGCL_WEB/resources/images/billing1.png" width="206" height="150">
...
function fetchBillingInfo()
{
   ...
   if(isValid==true)
	...
	$(".individual_overlay").css({
	  background:'url("/PGCL_WEB/resources/images/overlay1.png")',
	  opacity : 0.5,
