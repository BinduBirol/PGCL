...
public class BalanceSheetDTO {
	...
	private double securityCollection;
	private double securityMeterRent;
	private double securitySurcharge;
	...
	public void setSalesAdjustment(double salesAdjustment) {
		this.salesAdjustment = salesAdjustment;
	}
	public double getSecurityCollection() {
		return securityCollection;
	}
	public void setSecurityCollection(double securityCollection) {
		this.securityCollection = securityCollection;
	}
	public double getSecurityMeterRent() {
		return securityMeterRent;
	}
	public void setSecurityMeterRent(double securityMeterRent) {
		this.securityMeterRent = securityMeterRent;
	}
	public double getSecuritySurcharge() {
		return securitySurcharge;
	}
	public void setSecuritySurcharge(double securitySurcharge) {
