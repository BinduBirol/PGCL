	...
	public ResponseDTO saveMeterReading(String user_id,MeterReadingDTO reading)
	{
		...
		if(totalDayDiff<=0 && !(reading.getReading_purpose_str().equals("3")||reading.getReading_purpose_str().equals("8"))){
			...
			try
			{
				...
				stmt.setFloat(4, reading.getRate());
				...
				stmt.setFloat(8, reading.getPrev_reading());
				stmt.setString(9, reading.getPrev_reading_date());
				stmt.setFloat(10, reading.getCurr_reading());
				stmt.setString(11, reading.getCurr_reading_date());
				stmt.setFloat(12, reading.getDifference());
				stmt.setFloat(13, reading.getHhv_nhv());
				...
				stmt.setDouble(18, reading.getActual_consumption());
				stmt.setDouble(19, reading.getTotal_consumption());
				stmt.setFloat(20, reading.getMeter_rent());
				stmt.setFloat(21, reading.getPressure());
				stmt.setDouble(22, reading.getPressure_factor());
				stmt.setFloat(23, reading.getTemperature());
...
//		float propMaxLoad=Utils.getProportionalLoad(reading.getMax_load(), totalDayDiff,reading.getBilling_month(),reading.getBilling_year());
		...
		PreparedStatement stmt = null;
			...
			{
				stmt = conn.prepareStatement(sql);
				stmt.setFloat(1, reading.getCurr_reading());
				stmt.setString(2, reading.getCurr_reading_date());
				stmt.setFloat(3, reading.getDifference());
