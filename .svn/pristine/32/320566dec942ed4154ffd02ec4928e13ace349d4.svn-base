...
<script  type="text/javascript">
	navCache("securityDepositHome.action");
	setTitle("Security Deposite information");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Security Deposit Information</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="securityDepositInfo.action" style="margin-bottom: 1px;">
						<div class="row-fluid">
							<div class="span12">
									...
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="right" style="font-size: 12px;font-weight: bold;">
												...
												<input type="radio" value="account_wise" id="by_account" name="report_for" onclick="checkType(this.id)" /> Account Wise&nbsp;&nbsp;&nbsp;
				...
				<div class="row-fluid" id="account_div">
					<div class="row-fluid">								
						<div class="row-fluid">
									<div class="span12">
		...
		<div class="row-fluid" id="individual_div">
		    <div class="w-box-content" style="padding: 10px;" id="content_div">						
				...
				<div class="row-fluid" id="from_to_date_div">							
							<div class="span6" id="fromDateSpan">
				    			<label id="fromDateLabel">From Date</label>
								<input type="text" name="from_date_ind" id="from_date_ind" style="width: 54%" value="<s:property value='from_date' />"/>
				  			</div>
				  			<div class="span6" id="toDateSpan">
				    			<label id="toDateLabel">To Date</label>
								<input type="text" name="to_date_ind" id="to_date_ind" style="width: 54%" value="<s:property value='to_date' />"/>
				  			</div>
			    </div>										
		</div>
				</div>
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/securityDeposit.js"></script>	
