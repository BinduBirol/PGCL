			...
			<div class="list-group">
				<s:if test="#session.role=='Super Admin' || #session.role=='Manager' || #session.role=='Assistant Manager'">
	  			<a href="javascript:void(0)" onclick="callAction('meterReadingHome.action')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_mreading_16.png" />
					Meter Reading Entry
				</a>
				<a href="javascript:void(0)" onclick="callAction('supplyOffHome.action')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_supplyoff_16.png" />
					Gas Supply Off Info.
				</a>
				<a href="javascript:void(0)" onclick="callAction('billCreationHome.action?bill_parameter.isMetered_str=1')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_bill_process_16.png" />
					Bill Creation(Metered)
				</a>
				<a href="javascript:void(0)" onclick="callAction('downloadBillHome.action?bill_parameter.isMetered_str=1')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_bill_process_16.png" />
					Pre-printed Bill(Metered)
				</a>
				<a href="javascript:void(0)" onclick="callAction('billCreationHome.action?bill_parameter.isMetered_str=0')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_calcualte_16.png" />
				...
				<a href="javascript:void(0)" onclick="callAction('surchargeCalHome.action')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_surcharge_16.png" />
					Surcharge Calculation
				</a>
				<a href="javascript:void(0)" onclick="callAction('billAdjustmentOtherHome.action')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_adjustment_16.png" />
				...
				<a href="javascript:void(0)" onclick="callAction('billAdjustmentOtherNonMeterHome.action')" class="list-group-item">
					<img src="/PGCL_WEB/resources/images/icons/sb_adjusment_non_meter.png" />
				...
				<!-- callAction('billCreationHome.action?bill_parameter.isMetered_str=0') -->
			  	...
			  	<s:if  test=" #session.role=='Bank User' ">
					<section>
						
						
						<div>
							<a href="javascript:void(0)" onclick="callAction('billCollectionBank.action')" class="list-group-item">
								  		<img src="/PGCL_WEB/resources/images/icons/sb_collection_16.png" />
...
<s:if test="#session.role=='Super Admin' || #session.role=='Manager' || #session.role=='Assistant Manager'">			
	...
	<div>
		<div class="list-group">
		  ...
		  <img src="/PGCL_WEB/resources/images/icons/sb_security_deposit_exp_16.png" />
		  ...
		  <a href="javascript:void(0)" onclick="callAction('bankGarantieManagementHome.action')" class="list-group-item">
		  	<img src="/PGCL_WEB/resources/images/icons/sb_mrent_16.png" />
		  	BG Management</a>
		  <a href="javascript:void(0)" onclick="callAction('bankBalanceUpdateHome.action')" class="list-group-item">
		  	<img src="/PGCL_WEB/resources/images/icons/sb_mrent_16.png" />
		  	Bank Book Update
		  </a>
