...
import org.pgcl.models.MeterReadingService;
...
public class MeterReading extends BaseAction
{
	...
	public String fetchReadingEntry(){
		...
		reading=mrService.getReadingEntry(loggedInUser.getUserId(),ind,index_key,reading_id,customer_id,meter_id,billing_month,billing_year,reading_purpose,loggedInUser.getArea_id(),customer_category,reading_date);
		if(reading!=null) 			
