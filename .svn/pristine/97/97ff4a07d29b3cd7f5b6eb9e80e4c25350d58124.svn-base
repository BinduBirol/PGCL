<div class="ui-layout-north" id="northPanel" style="padding: 0px;">
	...
	<img src="/PGCL_WEB/resources/images/banner1.png" style="float: left;"/>
	<img src="/PGCL_WEB/resources/images/arrow1.png"  style="float: left;padding-top: 5px;padding-left: 5px;"> 
	<div id="page_title"  style="float: left;padding-top: 7px;padding-left: 4px;font-size: 13px;">User Home</div>
	
		<div  style="float: right;padding-top: 6px;font-size: 12px;padding-right: 10px;color: #004b5e;text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);font-weight: normal;">
			...
			&nbsp;&nbsp;|&nbsp;&nbsp; 
			<img src="/PGCL_WEB/resources/images/user_24.png"/> <s:property value="%{#session.user.userName}" />&nbsp;&nbsp;|&nbsp;&nbsp; 
			<a href="logout.action"><img src="/PGCL_WEB/resources/images/logout.png" width="15" /></a>
		</div>		 		
	</div>
</div>
<!-- 
