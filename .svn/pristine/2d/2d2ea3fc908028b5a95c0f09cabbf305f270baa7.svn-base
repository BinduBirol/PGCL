...
jQuery("#gridTable")
    .jqGrid({
        ...
        colNames: ['ID','Tariff No', 'Category','Meter Status','Burner Category','Description','Price','PB','Vat','Sd','Pdf','Bapex','WH','DWH','Transmission','GDfund','Distribution','Avalue','ShortFall','From','To','Default'],
        colModel: [{
		                name: 'tariff_id',
		                index: 'tariff_id',
		                editable: true,
