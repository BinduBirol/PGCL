...
<div class="w-box">
	...
	<div class="w-box-content" style="padding: 10px;" id="content_div">	
		<fieldset>
			<legend>Old Burner Info</legend>
						<div class="row-fluid">
						  	<div class="span4">									    
								<label style="width: 55%">Double Burner</label>
						        <input type="text" style="width: 25%" id="old_double_burner_qnt" name="bqc.old_double_burner_qnt" disabled="disabled"/>								      
							</div>
							<div class="span4">
								<label style="width: 55%">Per. DisConn Qnt</label>
								<input type="text" style="width: 25%" id=old_pdisconnected_burner_qnt name="bqc.old_pdisconnected_burner_qnt" disabled="disabled"/>
						  	</div>
						</div>
						<div class="row-fluid">
							 <div class="span4">
									<label style="width: 55%">Temp DisCon Qnt</label>
									<input type="text" style="width: 25%" id="old_tdisconnected_burner_qnt" name="bqc.old_tdisconnected_burner_qnt" disabled="disabled"/>
									<input type="hidden" style="width: 25%" id="old_double_burner_qnt_billcal" name="bqc.old_double_burner_qnt_billcal" disabled="disabled"/>
							 </div>	
							  <div class="span4">
									<label style="width: 55%">Temp. DisConn. Qnt (.5)</label>
									<input type="text" style="width: 25%" id="old_tdisconnected_half_burner_qnt" name="bqc.old_tdisconnected_half_burner_qnt" readonly/>	
							 </div>
			...
			<legend>New Burner Info</legend>			
						<div class="row-fluid">
						  	<div class="span6">									    
								...
								<div class="span6">
							<input type="checkbox" id="isIncraseSelected" disabled="disabled">  <font color="blue"> <b>Increase</b></font></input>
                            <input type="checkbox" id="isDisconnSelected" disabled="disabled"><font color="red"><b> Disconnection</b></font></input>
                            <input type="checkbox" id="isReconnSelected" disabled="disabled"><font color="green"><b> Reconnection</b></font></input>
			...
			<legend id="childSection"><b>Increase</b></legend>
						<div class="row-fluid">
							<div class="span6">									    
						        ...
						        <input type="text" style="width: 30%" id="new_incrased_burner_qnt" name="bqc.new_incrased_burner_qnt" disabled="disabled" onkeyup="calculateDoubleBurner(this.id)" maxlength="2"/>							      
							</div>							  	
						</div>
			</fieldset>
		</div>
		...
		<legend id="childSection"><b>Disconnection</b></legend>	
						<div class="row-fluid">
						  ...
						  <div class="span4">
							<label style="width: 30%; padding-left: 10px">Type:</label>
									<select id="disconn_type"  style="width: 30%;"   onchange="setDisconnType(this.id);calculateDoubleBurner(this.id)" name="bqc.disconn_type" disabled="disabled"">
									<option value="" selected="selected">Select Type</option>									
							...
							<div class="span4">
								...
								<select name="bqc.new_permanent_disconnected_cause" onchange="setDisconnType(this.id);calculateDoubleBurner(this.id)" id="new_permanent_disconnected_cause" disabled="disabled" style="width: 30%">
							...
							<div class="span4">									    
						        ...
						        <input type="text" style="width: 25%" id="burner_qnt_disconn" name="" onkeyup="setDisconnType(this.id);calculateDoubleBurner(this.id)" disabled="disabled" maxlength="2"/>							      
			...
			<legend id="childSection"><b>Reconnection</b></legend>		
						<div class="row-fluid">
							...
							<div class="span4">									    
								<label style="width: 30%; padding-left: 10px">Qnt.</label>
						        <input type="text" style="width: 25%" id="burner_qnt_reconn" name="" onkeyup="setReconnFrom(this.id);calculateDoubleBurner(this.id)" disabled="disabled" maxlength="2"/>							      
							</div>	
			...
			<div style="margin-top: 25px">
						<div class="row-fluid">		
						    <div class="span6">									    
						        ...
						        <input type="text" style="width: 30%" id="effective_date" name="bqc.effective_date" disabled="disabled"/>
							</div>							
						  	<div class="span6">									    
								<label style="width: 30%;padding-left: 10px">Remarks</label>
								<textarea rows="1" style="width: 59%" id="remarks" name="bqc.remarks" disabled="disabled"></textarea> 							      
							</div>						  	
						</div>
			</div>			
						...
						<div class="formSep sepH_b" style="padding-top: 3px;margin-bottom: 0px;padding-bottom: 2px;">									
						    ...
						    <tr>
						    	<td width="55%" align="left">
								    ...
								    Edit</button>
								    <button class="btn btn-beoro-3" type="button" id="btn_save" onclick="validateAndSaveBurnerQntChange()" disabled="disabled"><span class="splashy-document_letter_okay"></span>
								    Save</button>
