...
duesGrid.jqGrid({
	url: jsEnum.GRID_RECORED_FETCHER+'?service=org.pgcl.models.BillingService&method=getDueBillList',
   	jsonReader: {
            repeatitems: false,
            id: "bill_id"
	},
...
installmentHistoryGrid.jqGrid({
	url: jsEnum.GRID_RECORED_FETCHER+'?service=org.pgcl.models.InstallmentService&method=getInstallmentHistory',
 	jsonReader: {
          repeatitems: false,
          id: "agreement_id"
	},
