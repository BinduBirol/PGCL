...
<div class="meter-reading" style="width: 75%;height: 50%;">
	<div class="row-fluid">
			...
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div" >
     				...
     				<form id="billProcessForm" name="billProcessForm" action="yearlyBalanceSheetInfo.action" style="margin-bottom: 1px;">
									...
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="right" style="font-size: 12px;font-weight: bold;">
												...
												<input type="radio" value="category_wisef" id="category_wisef" name="report_for" onclick="checkType(this.id)" /> Category Wise PGCL Summary&nbsp;&nbsp;&nbsp;
											</td>											
										</tr>
									</table>
                                </div>
						...
						<div class="row-fluid" id="meter_nonMeter" style="width: 100%">							
							<div class="span6">									    
