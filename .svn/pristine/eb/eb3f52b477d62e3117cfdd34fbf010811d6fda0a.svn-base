...
public class DefaulterCertificate extends ActionSupport implements ServletContextAware{
	...
	ArrayList<ClearnessDTO> dueCustomerList=new ArrayList<ClearnessDTO>();
	ArrayList<ClearnessDTO> withoutDueCustomerList=new ArrayList<ClearnessDTO>();
	...
	static DecimalFormat consumption_format = new DecimalFormat("##########0.00");
	...
	{	
		...
		Rectangle one = new Rectangle(700,792); // For Single Page
							...
							if(listSize==0 ){
								...
								if(collection_month==null && calender_year==null ){
									...
									if(print_type.equals("01")){
										...
										realPath = servlet.getRealPath("/resources/staticPdf/dilipvai.pdf");
									}
...
/*-----------------------------------------second part-----------------------------------------------*/
										...
										//////////////////////////////////////////////////////////////////prprinted///////////////////////////////////////////////////////////////////////realPath = servlet.getRealPath("/resources/staticPdf/CCertificate.pdf");		
										document = new Document();
										out = new ByteArrayOutputStream();
										//left,right,top,bottom
										fileName="ClearnessCertificate.pdf";			
										...
										over.beginText();
											...
											double bqty=clearnessDTO.getBurner();
											String monthYear=Month.values()[Integer.valueOf(collection_month)-1]+","+calender_year;
										
											String burnerQty=Double.toString(bqty);
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(350, 761);
											over.showText(String.valueOf(Area.values()[Integer.valueOf(loggedInUser.getArea_id())-1]));
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(510, 740);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(178, 698);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 12);
											over.setTextMatrix(28, 676);
											over.showText(monthYear);
											
											over.setFontAndSize(bf, 17);
											over.setTextMatrix(15, 578);
											over.showText(clearnessDTO.getCustomerID());
											
											over.setFontAndSize(bf, 17);
											over.setTextMatrix(210, 578);
											over.showText(burnerQty);
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(48, 501);
											over.showText(clearnessDTO.getCustomerName());
											
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(470, 497);
											over.showText(officer_name==null?"":officer_name);
											
											over.setFontAndSize(bf, 12);
											over.setTextMatrix(460, 480);
											over.showText(officer_desig==null?"":officer_desig);
											
											/*-----------------------------------------second part-----------------------------------------------*/
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(350, 344);
											over.showText(String.valueOf(Area.values()[Integer.valueOf(loggedInUser.getArea_id())-1]));
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(510, 323);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(178, 281);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 12);
											over.setTextMatrix(28, 259);
											over.showText(monthYear);
											
											over.setFontAndSize(bf, 17);
											over.setTextMatrix(15, 161);
											over.showText(clearnessDTO.getCustomerID());
											
											over.setFontAndSize(bf, 17);
											over.setTextMatrix(210, 161);
											over.showText(burnerQty);
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(48, 84);
											over.showText(clearnessDTO.getCustomerName());
											
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(470, 74);
											over.showText(officer_name==null?"":officer_name);
											
											over.setFontAndSize(bf, 12);
											over.setTextMatrix(460, 60);
											over.showText(officer_desig==null?"":officer_desig);
											...
											ColumnText ct = new ColumnText(over);						
											ct.setSimpleColumn(new Phrase(new Chunk(clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 8, Font.NORMAL))),
													15, 493, 380, 60, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
											ct.go();
																	
											ColumnText ct1 = new ColumnText(over);						
											ct1.setSimpleColumn(new Phrase(new Chunk(clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 8, Font.NORMAL))),
													15, 75, 380, 50, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
											ct1.go();
											}else{
												
												if(clearnessDTO.getPhoneNo()==null){
													ColumnText ct = new ColumnText(over);						
													ct.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.NORMAL))),
															15, 493, 380, 60, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
													ct.go();
																			
													ColumnText ct1 = new ColumnText(over);						
													ct1.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.NORMAL))),
															15, 75, 380, 50, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
													ct1.go();
												}else{
												
													ColumnText ct = new ColumnText(over);						
													ct.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.NORMAL))),
															15, 493, 380, 60, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
													ct.go();
																		
													ColumnText ct1 = new ColumnText(over);						
													ct1.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.NORMAL))),
															15, 75, 380, 50, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
													ct1.go();
													}
											}
...
//											over.showText(String.valueOf(Area.values()[Integer.valueOf(loggedInUser.getArea_id())-1]));
										...
										//realPath = servlet.getRealPath("/resources/staticPdf/ClearnessCertificate.pdf");	Pre-printed With Due----------------------------------------------------------------------------------------------------	
										document = new Document();
										out = new ByteArrayOutputStream();
										//left,right,top,bottom
										fileName="ClearnessCertificate.pdf";			
										...
										for (int i = 0; i < listSize; i++) {
											...
											countMonth=countMonth+i+1;
											dueMonth=duesString.substring(1);
											
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(342, 781);
											over.showText(String.valueOf(Area.values()[Integer.valueOf(loggedInUser.getArea_id())-1]));
											
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(496, 767);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 15);
											over.setTextMatrix(138, 726);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 17);
											over.setTextMatrix(516, 725);
											over.showText(clearnessDTO.getCustomerID());
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(56, 711);
											over.showText(Month.values()[Integer.valueOf(collection_month)-1]+","+calender_year);
											...
											over.showTextAligned(PdfContentByte.ALIGN_RIGHT,burnerQty,393, 628,0);
											
											//over.setFontAndSize(bf, 16);
											//over.setTextMatrix(445, 628);
											//over.showText(String.valueOf(taka_format.format(totaldueAmount)));
//											over.showText("ABCDEFG");
											over.setFontAndSize(bfBold, 16);
											over.showTextAligned(PdfContentByte.ALIGN_RIGHT,consumption_format.format(totaldueAmount),539, 628,0);
											
											String totalMonth=Integer.toString(countMonth);
											over.setFontAndSize(bf, 17);
											over.showTextAligned(PdfContentByte.ALIGN_RIGHT,totalMonth,590, 628,0);
											
											//over.setTextMatrix(540, 628);
											//over.showText(totalMonth);
...
//											over.showText(String.valueOf(Area.values()[Integer.valueOf(loggedInUser.getArea_id())-1]));
											...
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(65, 487);
											over.showText(clearnessDTO.getCustomerName());
											
											over.setFontAndSize(bfBold, 16);
											over.setTextMatrix(490, 460);
											over.showText(officer_name==null?"":officer_name);
											
											over.setFontAndSize(bf, 13);
											over.setTextMatrix(490, 446);
											over.showText(officer_desig==null?"":officer_desig);
											...
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(342, 364);
											over.showText(String.valueOf(Area.values()[Integer.valueOf(loggedInUser.getArea_id())-1]));
											
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(496, 350);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 16);
											over.setTextMatrix(138, 310);
											over.showText(clearnessDTO.getTodaysDate());
											
											over.setFontAndSize(bf, 17);
											over.setTextMatrix(516, 309);
											over.showText(clearnessDTO.getCustomerID());
											
											over.setFontAndSize(bf, 14);
											over.setTextMatrix(56, 294);
											over.showText(Month.values()[Integer.valueOf(collection_month)-1]+","+calender_year);
											
											
										
											over.setFontAndSize(bfBold, 16);
											over.showTextAligned(PdfContentByte.ALIGN_RIGHT,burnerQty,393, 212,0);
											
											/*over.setFontAndSize(bf, 16);
											over.setTextMatrix(445, 212);
											over.showText(String.valueOf(taka_format.format(totaldueAmount)));	
											
											over.setFontAndSize(bf, 17);
											over.setTextMatrix(540, 212);
											over.showText(totalMonth);*/
											
											over.setFontAndSize(bfBold, 16);
											over.showTextAligned(PdfContentByte.ALIGN_RIGHT,consumption_format.format(totaldueAmount),539, 212,0);
											
											
											over.setFontAndSize(bf, 17);
											over.showTextAligned(PdfContentByte.ALIGN_RIGHT,totalMonth,590, 212,0);
											
											over.setFontAndSize(bf, 15);
											over.setTextMatrix(290, 147);
											over.showText(areaName);
...
//											over.showText(String.valueOf(Area.values()[Integer.valueOf(loggedInUser.getArea_id())-1]));
											...
											over.setFontAndSize(bfBold, 16);
											over.setTextMatrix(490, 45);
											over.showText(officer_name==null?"":officer_name);
											
											over.setFontAndSize(bf, 13);
											over.setTextMatrix(490, 32);
											over.showText(officer_desig==null?"":officer_desig);
											...
											ct.setSimpleColumn(new Phrase(new Chunk(dueMonth, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
													0, 658, 345, 60, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
											ct.go();
											

											ct.setSimpleColumn(new Phrase(new Chunk(dueMonth, FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
													0, 240, 345, 60, 15, Element.ALIGN_LEFT | Element.ALIGN_TOP);
											ct.go();
											
											if(clearnessDTO.getFathersName().equalsIgnoreCase("N/A") || clearnessDTO.getFathersName()==null){
											//ColumnText ct = new ColumnText(over);						
											ct.setSimpleColumn(new Phrase(new Chunk(clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
													42, 476, 370, 50, 10, Element.ALIGN_LEFT | Element.ALIGN_TOP);
											ct.go();
											
											ct.setSimpleColumn(new Phrase(new Chunk(clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
													42, 33, 370, 50, 10, Element.ALIGN_LEFT | Element.ALIGN_TOP);
											ct.go();
											}else{
												if(clearnessDTO.getPhoneNo()==null){
													ct.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
															40, 476, 370, 50, 10, Element.ALIGN_LEFT | Element.ALIGN_TOP);
													ct.go();
													
													ct.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
															40, 30, 370, 60, 10, Element.ALIGN_LEFT | Element.ALIGN_TOP);
													ct.go();
												}else{
												
												ct.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
														40, 476, 370, 50, 10, Element.ALIGN_LEFT | Element.ALIGN_TOP);
												ct.go();
												
												ct.setSimpleColumn(new Phrase(new Chunk("C/O-"+clearnessDTO.getFathersName()+","+clearnessDTO.getCustomerAddress()+", "+clearnessDTO.getPhoneNo(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.NORMAL))),
														40, 33, 370, 50, 10, Element.ALIGN_LEFT | Element.ALIGN_TOP);
												ct.go();
												}
											}
	...
	public ArrayList<ClearnessDTO> getDueMonthWeb(String customer_id, String billIds){
		...
		try {
			String transaction_sql="select customer_id, BILL_ID, BILL_MONTH, BILL_YEAR,MONTH_YEAR,PAYABLE_AMOUNT,PAID_AMOUNT,DUE_AMOUNT,round((PAYABLE_AMOUNT*12*daydiff)/(100*365),0) Surcharge from( " +
					...
					"       BILLED_AMOUNT PAYABLE_AMOUNT, " +
					"       NVL (COLLECTED_BILLED_AMOUNT, 0) PAID_AMOUNT, " +
					"       BILLED_AMOUNT - NVL (COLLECTED_BILLED_AMOUNT, 0) DUE_AMOUNT,null Surcharge " +
					"  FROM BILL_NON_METERED " +
	...
	private ArrayList<ClearnessDTO> getCustomerList(String from_cus_id,String to_cus_id,String cus_type,String cust_cat_id,String area){
		...
		try {
			String transaction_sql="";
					...
					if(due_status.equals("01")){
						transaction_sql="select CUSTOMER_ID,STATUS,PAYMENT from  " +
								"(select CUSTOMER_ID,to_number(substr(CUSTOMER_ID,1,9)) CUS_ID,getDuesStatus(CUSTOMER_ID,"+calender_year+",ISMETERED) STATUS,getPaymentStatus(CUSTOMER_ID,'"+calender_year+"','"+collection_month+"') PAYMENT from MVIEW_CUSTOMER_INFO  " +
								"Where substr(CUSTOMER_ID,1,2)=" +area+
								"AND ISMETERED="+cus_type+
								"AND CATEGORY_ID=" +cust_cat_id+")"+
								"Where STATUS=1 and cus_id between "+from_cus_id+" and "+to_cus_id + " AND PAYMENT='P'"+
						...
						transaction_sql="select CUSTOMER_ID,STATUS,PAYMENT from  " +
								...
								"AND ISMETERED="+cus_type+
								"AND CATEGORY_ID=" +cust_cat_id+")"+
								"Where STATUS=1 and cus_id between "+from_cus_id+" and "+to_cus_id + " AND PAYMENT='U'"+
								"  order by CUSTOMER_ID ";
					}
