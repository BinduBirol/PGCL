...
<script  type="text/javascript">
	navCache("advancedPaidCustomerInfoHome.action");
	setTitle("Advance Paid Customer Information");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Advance Paid Customer Details</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="advancePaidCustomerInfo.action" style="margin-bottom: 1px;">
						<div class="row-fluid">
							<div class="span12">
						...
						<div class="row-fluid">							
							...
							<div class="span6">
								<label style="width: 40%">No. of Advanced Month<m class='man'/></label>
