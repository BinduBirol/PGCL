...
public class TotalSecurityDepositReport extends BaseAction {
	...
	public String execute() throws Exception {
		...
		try {
			...
			Chunk chunk2 = new Chunk("Nalka Sirajganj",font3);
			...
			String[] areaList={"01","02","03","04","05","06","07","08","09","10"};
			...
			pcell=new PdfPCell(new Paragraph("Area Name : "+Area.values()[Integer.valueOf(area)-1],font3));
			pcell.setColspan(9);
			...
			try {
				for (int i = 0; i < listSize; i++) {
					...
					if(!category.equals("10") && !category.equals("08")){
						...
						totalCashAmt=totalCashAmt+securityList.get(i).getCashBank();
						totalBankGauranty=totalBankGauranty+securityList.get(i).getBankGuaranty();
						totalFdrAmt=totalFdrAmt+securityList.get(i).getFdr();
						totalPsfOthers=totalPsfOthers+securityList.get(i).getPsp()+securityList.get(i).getOthers();
						securityAmt=securityAmt+totalCashAmt+totalBankGauranty+totalFdrAmt+totalPsfOthers;
						
						
						cashAmt=cashAmt+securityList.get(i).getCashBank();
						bankGauranty=bankGauranty+securityList.get(i).getBankGuaranty();
						fdrAmt=fdrAmt+securityList.get(i).getFdr();
						psfOthers=psfOthers+securityList.get(i).getPsp()+securityList.get(i).getOthers();
						...
						if(category.equals("09") || category.equals("07")){
							pcell=new PdfPCell(new Paragraph(securityList.get(i).getCustomerCategoryName(),ReportUtil.f11B));
							pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
							datatable1.addCell(pcell);
							...
							pcell=new PdfPCell(new Paragraph(taka_format.format(securityList.get(i).getCashBank()),ReportUtil.f11B));
							pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							datatable1.addCell(pcell);
							
							pcell=new PdfPCell(new Paragraph(taka_format.format(securityList.get(i).getBankGuaranty()),ReportUtil.f11B));
							pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							datatable1.addCell(pcell);
							
							pcell=new PdfPCell(new Paragraph(taka_format.format(securityList.get(i).getFdr()),ReportUtil.f11B));
							pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							datatable1.addCell(pcell);
							
							pcell=new PdfPCell(new Paragraph(taka_format.format(securityList.get(i).getPsp()+securityList.get(i).getOthers()),ReportUtil.f11B));
							pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							datatable1.addCell(pcell);
							...
							pcell=new PdfPCell(new Paragraph(securityList.get(i).getCustomerCategoryName(),font3));
							pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
							datatable1.addCell(pcell);
