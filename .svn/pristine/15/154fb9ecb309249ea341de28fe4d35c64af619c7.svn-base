...
<script  type="text/javascript">
	navCache("sgHome.action");
	setTitle("Accounts Payable (SGFL) Report");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Liabilities for Wellhead, SD &amp; VAT (SGFL)</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="sgInfo.action" style="margin-bottom: 1px;">
