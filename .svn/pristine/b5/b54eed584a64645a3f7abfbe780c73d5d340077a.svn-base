...
<link rel="stylesheet" href="/PGCL_WEB/resources/thirdParty/smart-wizard/styles/smart_wizard.css">
<script src="/PGCL_WEB/resources/thirdParty/smart-wizard/js/jquery.smartWizard.js"></script>
...
<script type="text/javascript">
	...
	function validateStep3(){
		  ...
		  if($.trim($("#meter_type").val())=="")
		  	{cbColor($("#meter_type"),"e");isValid=false;}
		  else cbColor($("#meter_type"),"v");
		  if($.trim($("#meter_category").val())=="")
		  	{cbColor($("#meter_category"),"e");isValid=false;}
		  else cbColor($("#meter_category"),"v");
    ...
    function validateAllSteps(){
       ...
       return isStepValid;
		...
		function setCategory(category)
		{
		 	...
		 	{
		 	 $("#div_proprietor").hide();$("#proprietor_name").val(jsVar.EMPTY);
		 	 $("#div_bl").hide();$("#license_number").val(jsVar.EMPTY);
		 	 $("#div_vat").hide();$("#vat_reg_no").val(jsVar.EMPTY);
		 	...
		 	else
		 	{
		 	 ...
		 	 $("#div_nid").hide();$("#national_id").val(jsVar.EMPTY);
		 	 $("#div_passport").hide();$("#passport_no").val(jsVar.EMPTY);
		 	}
		}
      ...
      $.jgrid.info_dialog(response.dialogCaption,response.message,$.jgrid.edit.bClose, {
	                    ...
	                    width:450,
	                     ...
	                     onClose: function () {
    						...
    						$("#contentPanel").html("<center><img  src='/PGCL_WEB/resources/images/emptyContent.png' /></center>");
