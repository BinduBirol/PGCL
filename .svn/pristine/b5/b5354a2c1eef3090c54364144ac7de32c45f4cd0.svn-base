...
<script  type="text/javascript">
	navCache("distHome.action");
	setTitle("Accounts Payable (Distribution Margin) Report");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Liabilities for Distribution Margin</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="distInfo.action" style="margin-bottom: 1px;">
