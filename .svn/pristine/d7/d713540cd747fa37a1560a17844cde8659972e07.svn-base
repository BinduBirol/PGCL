...
var jsEnum = { //not really an enum, just an object that serves a similar purpose
		...
		ACCOUNT_LIST : "getAccountList",
  		...
  		COLLECTION_SERVICE : "org.pgcl.models.CollectionService",
  		ADJUSTMENT_COLLECTION_SERVICE : "org.pgcl.models.AdjustmentCollectionService",
  		COLLECTION_LIST : "getCollectionList",
  		DISCONNECTION_SERVICE: "org.pgcl.models.DisconnectionService",
  		METER_DISCONNECTION_LIST: "getMeterDisconnectionList",
  		NONMETER_DISCONNECTION_LIST: "getNonMeterDisconnectionList",
  		RECONNECTION_SERVICE: "org.pgcl.models.ReconnectionService",
  		...
  		CUSTOMER_SERVICE : "org.pgcl.models.CustomerService",
  		...
  		DEPOSIT_SERVICE : "org.pgcl.models.DepositService",  
  		...
  		METER_SERVICE : "org.pgcl.models.MeterService", 
  		...
  		METER_READING_SERVICE : "org.pgcl.models.MeterReadingService",
  		METER_READING_LIST: "getSavedReadingList",
  		METER_READING_HISTORY_LIST:"getReadingHistoryList",
  		METER_RENT_SERVICE:"org.pgcl.models.MeterRentService",
  		METER_RENT_CHANGE_LIST: "getMeterRentChangeList",
  		TYPE_CHANGE_SERVICE:"org.pgcl.models.CustomerTypeChangeService",
  		TYPE_CHANGE_LIST: "getCustomerTypeChangeList",
  		READ_ONLY : "readonly",
  		STAR : "&nbsp;<font color='red'>*</font>",
  		TARIFF_SERVICE : "org.pgcl.models.TariffService",
  		...
  		LOAD_PRESSURE_CHANGE_SERVICE: "org.pgcl.models.LoadPressureChangeService",
  		LOAD_PRESSURE_CHANGE_LIST: "getLoadPressureChangeList",
  		  		
  		OWNERSHIP_CHANGE_HISTORY_LIST: "ownershipChangeHistory",
  		
  		BURNER_QNT_CHANGE_SERVICE : "org.pgcl.models.BurnerQntChangeService",
  		BURNER_QNT_CHANGE_LIST: "getBurnerQntChangeList",
  		
  		METER_REPLACEMENT_SERVICE:"org.pgcl.models.MeterReplacementService",
  		METER_REPLACEMENT_LIST: "getMeterReplacementList",
  		
  		USER_SERVICE : "org.pgcl.models.UserService",
  		USER_ADD : "addUser",
  		USER_UPDATE : "updateUser",
  		USER_DELETE : "deleteUser",
  		USER_LIST : "getUserList",
  		VALIDATE_USER:"validateUserId",
  		SUPPLYOFF_SERVICE : "org.pgcl.models.SupplyOffService",
  		SUPPLYOFF_LIST : "getSupplyOffList",
  	    
		BANK_TRANSACTION_SERVICE : "org.pgcl.models.BankTransactionService",
...
var jsCaption= {		
		...
		CAPTION_CUSTOMER_CATEGORY: "Master Data : PGCL Customer Category",
		...
		CAPTION_CUSTOMER_LIST: "PGCL Customer List",
...
var jqCaption= {
		...
		LIST_ACCOUNT:"PGCL Meter Type",
		LIST_AREA:"PGCL Area/Region",
		LIST_BANK:"Bank List",
		LIST_BRANCH:"Branch List",
		LIST_CUSTOMER:"Customer List",
		LIST_CUSTOMER_CATEGORY:"PGCL Customer Category",		
		LIST_DEPOSIT_TYPE:"PGCL Deposit Type",
		LIST_METER_TYPE:"PGCL Meter Type",
		LIST_TARIFF:"Tariff/Rate",
		LIST_USER:"PGCL User List",
...
var jsImg= {		
		AVATAR_80:"<img class='img-avatar' src='/PGCL_WEB/resources/images/avatar.png' alt='' >",
		SPINNER : "<img src='/PGCL_WEB/resources/images/loading/spinner.gif' alt='loading...' />",
		LOADING : "<img src='/PGCL_WEB/resources/images/loading/loading.gif' alt='loading...' />",
		SETTING : "<img src='/PGCL_WEB/resources/images/loading/setting.gif' alt='loading...' />",
		LOADING_MID : "<img src='/PGCL_WEB/resources/images/loading/loading_mid.gif' alt='loading...' />"
}
...
var jsVar={
		...
		USER_PHOTO_URL:"http://localhost/PGCL_PHOTO/user/",
		CUSTOMER_PHOTO_URL:"http://localhost/PGCL_PHOTO/customer/",
		NO_PHOTO_URL:"http://localhost/PGCL_PHOTO/noPhoto.jpg",
		DEFAULT_PHOTO_URL:"http://localhost/PGCL_PHOTO/noPhoto.jpg",
		...
		LOCAL_ACTION_STORAGE:"pgcl_action",
		MODAL_THEME:'black'
...
var msgDiv="<div style='color: red;min-height: 200px;padding: 20px;'> "+
	"<center>"+
		"<img src='/PGCL_WEB/resources/images/info.png' width='80' height='80'/><br/><br/>"+
...
"<div class='w-box-content' style='padding: 10px;' id='content_div'>"+
	 "<center>"+
	 "<img src='/PGCL_WEB/resources/images/select.jpg' style='padding: 60px 0 60px 0;'/>"+                         
	 "</center>"+
"</div>"+
"</div>";
