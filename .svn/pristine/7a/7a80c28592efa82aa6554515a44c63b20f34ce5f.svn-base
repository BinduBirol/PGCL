...
<div class="row-fluid">   
    ...
    <div class="span6">
        <label style="width: 40%">Pressure</label>
						...
						<div class="formSep sepH_b" style="padding-top: 3px;margin-bottom: 0px;padding-bottom: 2px;">									
						    ...
						    <tr>
						    	<td width="55%" align="left">
									...
									Add</button>
								    <button class="btn btn-beoro-3" type="button" id="btn_save" onclick="validateAndSaveMeterReplacementInfo()" disabled="disabled"><span class="splashy-document_letter_okay"></span>
								    Save</button>
