                        ...
                        <s:iterator value="holidayList" status="indx">
                         ...
                         <s:set var="m_y" value="month_year" />                                                 
	                        <li>
	                            ...
	                            <img src="/PGCL_WEB/resources/images/edit_16.png" style="cursor: pointer;" class='img_edit' onclick="updateHome(<s:property value="holiday_id"/>)"/>
	                            <img src="/PGCL_WEB/resources/images/delete_16.png" style='margin-left:15px;cursor: pointer;' class='img_del' onclick="deleteHoliday(<s:property value="holiday_id"/>,'<s:property value="holiday_date"/>','<s:property value="holiday_cause"/>','<s:property value="holiday_type_name"/>')" />
...
<script src="/PGCL_WEB/resources/thirdParty/stickySectionHeaders/jquery.stickysectionheaders.min.js"></script>                        
