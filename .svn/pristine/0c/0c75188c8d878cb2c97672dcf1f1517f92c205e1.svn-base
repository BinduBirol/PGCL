...
public class MeterReadingReport extends BaseAction {
	...
	private void generatePdfMeterReadingAreaWise(Document document) throws DocumentException{
		...
		double totalCurrentReading=0.0;
		double totalPrevReading=0.0;
		double totalPressure=0.0;
		double totalPressureFactor=0.0;
		double totalMeterRent=0.0;
		double totalMinLoad=0.0;
		...
		for(int i=0;i<expireListSize;i++)
		{
			...
			totalCurrentReading=totalCurrentReading+meterReadingDTO.getCurr_reading();		
			...
			totalPrevReading=totalPrevReading+meterReadingDTO.getPrev_reading();
			...
			totalPressure=totalPressure+meterReadingDTO.getPressure();
			...
			totalPressureFactor=totalPressureFactor+meterReadingDTO.getPressure_factor();
			...
			totalMeterRent=totalMeterRent+meterReadingDTO.getMeter_rent();
			...
			totalMinLoad=totalMinLoad+meterReadingDTO.getMin_load();
			...
			totalMaxLoad=totalMaxLoad+meterReadingDTO.getMax_load();
			...
			totalPercent=totalPercent+meterReadingDTO.getPercent();
			...
			total_burner=total_burner+meterReadingDTO.getBurnerQty();
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalCurrentReading),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalPrevReading),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalPressure),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalPressureFactor),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalMeterRent),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalMinLoad),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalMaxLoad),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(totalPercent),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
		...
		pcell=new PdfPCell(new Paragraph(consumption_format.format(total_burner),ReportUtil.f8B));
		pcell.setMinimumHeight(18f);
		pcell.setColspan(1);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);			
