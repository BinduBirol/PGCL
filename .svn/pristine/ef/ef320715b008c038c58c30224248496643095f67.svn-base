...
<div id="sw-basic-step-1" style="overflow: auto;">
        ...
        <div class="span8">
            ...
            <div class="row-fluid">                
                <div class="span6">
                    ...
                    <input type="text" id=proprietor_name name="personal.organization_name" maxlength="100" style="width: 50%;"/>
                </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span4">
            ...
            <input type="text" name="personal.mobile" id="mobile" maxlength="15" style="width: 50%;"/>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span4">
