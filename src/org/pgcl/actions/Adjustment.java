...
public class Adjustment extends BaseAction {
	...
	public String saveSalesAdjustmentInfo(){
		BillingService billService=new BillingService();
		ResponseDTO response =billService.saveSalesAdjustmentBilling(customer_id,bill_month,bill_year,issue_date,due_date,bill_amount,surcharge_amount, meter_rent,hhv_amount,total_consumption, payment_status,effective_date);
		setJsonResponse(response);
		return null;
	}
	...
	public double getHhv_amount() {
		return hhv_amount;
	}
	public void setHhv_amount(double hhv_amount) {
		this.hhv_amount = hhv_amount;
	}
