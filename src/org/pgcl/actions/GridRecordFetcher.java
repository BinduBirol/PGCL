...
import org.pgcl.dto.JqGridData;
...
public class GridRecordFetcher extends BaseAction {
	...
	public String execute() {
		...
		try {
			...
			totalList = (List<?>) method.invoke(obj, start, rows, where, sidx,
					sord, 0);
			dataList = (List<?>) method.invoke(obj, start, rows, where, sidx,
					sord, 9);
		...
		JqGridData<?> gridData = new JqGridData(totalPages, page, totalCount,
				dataList);
