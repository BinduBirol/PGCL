...
public class MBillDTO {
	...
	private double actual_minimum_load;
	...
	public String getDueBillInfo() {
		return dueBillInfo;
	}
	public void setDueBillInfo(String dueBillInfo) {
		this.dueBillInfo = dueBillInfo;
	}
	public double getActual_minimum_load() {
		return actual_minimum_load;
	}
	public void setActual_minimum_load(double actual_minimum_load) {
		this.actual_minimum_load = actual_minimum_load;
	}
