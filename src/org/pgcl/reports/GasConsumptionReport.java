...
//************************************ PGCL Logo *******************************************************
			...
			pcell=new PdfPCell(new Paragraph(consumption_format.format(monthlySalesInfo.get("total_sales_pgcl")),font3));
			pcell.setColspan(1);
			pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
			pcell.setBorder(0);
			summeryInfotable.addCell(pcell);
			...
			pcell=new PdfPCell(new Paragraph("C=GTCL/PGCL = ",font3));
			pcell.setRowspan(1);
			pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			pcell.setBorder(0);
			summeryInfotable.addCell(pcell);
			
			pcell=new PdfPCell(new Paragraph(consumption_format.format(monthlyGasPurchase.getTotal_gtcl()/monthlySalesInfo.get("total_sales_pgcl")),font3));
			pcell.setColspan(1);
			pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
			pcell.setBorder(0);
			summeryInfotable.addCell(pcell);
