...
public class SecurityAdjustmentJV extends BaseAction {
	...
	public String execute() throws Exception
	{
		...
		try{
			...
			pcell = new PdfPCell(new Paragraph("JV-01",ReportUtil.f9));
			...
			pcell = new PdfPCell(new Paragraph("Amount",ReportUtil.f9));
			pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			jvTable.addCell(pcell);
			...
			/*------------------------------End of JV-01-------------------------------------------------------------------------*/
				...
				pcell = new PdfPCell(new Paragraph("(When Security Deposit is refunded to customers for Permanent Discon/Excess paid etc.)",ReportUtil.f8));
				pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
				pcell.setColspan(7);
				jvTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("JV-02",ReportUtil.f9));
			pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			transferTable.addCell(pcell);
				...
				pcell = new PdfPCell(new Paragraph("(When Security Deposit is Transferred to another Bank A/c.)",ReportUtil.f8));
				pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
				pcell.setColspan(7);
				transferTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("JV-03",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			pcell = new PdfPCell(new Paragraph("Security Deposit(Customer)",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			
			pcell = new PdfPCell(new Paragraph("Dr",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Amount",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Accounts Receivable ( Power )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			
			pcell = new PdfPCell(new Paragraph("Cr",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Accounts Receivable ( CNG )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Accounts Receivable ( Captive )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Accounts Receivable ( Industrial )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Accounts Receivable ( Commercial )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Accounts Receivable ( Domestic )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Mt'r Rent Receivable ( Power )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Mt'r Rent Receivable ( CNG )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Mt'r Rent Receivable ( Captive )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph("Mt'r Rent Receivable ( Industrial )",ReportUtil.f9B));
			pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
			receiveTable.addCell(pcell);
			...
			receiveTable.addCell(pcell);
				...
				pcell = new PdfPCell(new Paragraph("(When Security Deposit will be adjusted against Arrear gas bill of customer.)",ReportUtil.f8));
				pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
				pcell.setColspan(7);
				receiveTable.addCell(pcell);
