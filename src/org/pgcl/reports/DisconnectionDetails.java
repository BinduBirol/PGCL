...
public class DisconnectionDetails extends BaseAction {
    ...
    private  String disconnect_type_m;
...
//************************************ PGCL Logo *******************************************************
	...
	private void generatePdfMeteredCustomer(Document document) throws DocumentException{
		...
		if(disconnect_type_m.equals("01")){
		
			if(report_for2.equals("date_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR ILLEGAL CONNECTION & RECEIVABLE AMOUNT FOR THE DAY OF "+from_date+" TO "+to_date;
			}else if(report_for2.equals("month_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR ILLEGAL CONNECTION & RECEIVABLE AMOUNT FOR THE MONTH OF "+Month.values()[Integer.valueOf(bill_month)-1]+"'"+bill_year;
			}else if(report_for2.equals("year_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR ILLEGAL CONNECTION & RECEIVABLE AMOUNT FOR THE MONTH OF "+bill_year;
			}
		}else if(disconnect_type_m.equals("02")){
			if(report_for2.equals("date_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR GAS BILL DUE & RECEIVABLE AMOUNT FOR THE DAY OF "+from_date+" TO "+to_date;
			}else if(report_for2.equals("month_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR GAS BILL DUE & RECEIVABLE AMOUNT FOR THE MONTH OF "+Month.values()[Integer.valueOf(bill_month)-1]+"'"+bill_year;
			}else if(report_for2.equals("year_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR GAS BILL DUE & RECEIVABLE AMOUNT FOR THE MONTH OF "+bill_year;
			}
		}else if(disconnect_type_m.equals("03")){
			if(report_for2.equals("date_wise")){
		...
		}else if(disconnect_type_m.equals("04")){
			if(report_for2.equals("date_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO NATURAL CALAMITY & RECEIVABLE AMOUNT FOR THE DAY OF "+from_date+" TO "+to_date;
			}else if(report_for2.equals("month_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO NATURAL CALAMITY & RECEIVABLE AMOUNT FOR THE MONTH OF "+Month.values()[Integer.valueOf(bill_month)-1]+"'"+bill_year;
			}else if(report_for2.equals("year_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO NATURAL CALAMITY & RECEIVABLE AMOUNT FOR THE MONTH OF "+bill_year;
			}
		}else if(disconnect_type_m.equals("05")){
			if(report_for2.equals("date_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO GOVT TRANSFER & RECEIVABLE AMOUNT FOR THE DAY OF "+from_date+" TO "+to_date;
			}else if(report_for2.equals("month_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO GOVT TRANSFER & RECEIVABLE AMOUNT FOR THE MONTH OF "+Month.values()[Integer.valueOf(bill_month)-1]+"'"+bill_year;
			}else if(report_for2.equals("year_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO GOVT TRANSFER & RECEIVABLE AMOUNT FOR THE MONTH OF "+bill_year;
			}
		}else if(disconnect_type_m.equals("06")){
			if(report_for2.equals("date_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR Due TO CUSTOMER TYPE CHANGE & RECEIVABLE AMOUNT FOR THE DAY OF "+from_date+" TO "+to_date;
			}else if(report_for2.equals("month_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO CUSTOMER TYPE CHANGE & RECEIVABLE AMOUNT FOR THE MONTH OF "+Month.values()[Integer.valueOf(bill_month)-1]+"'"+bill_year;
			}else if(report_for2.equals("year_wise")){
				headLine="THE STATEMENT SHOWING THE DISCONNECTED CUSTOMER INFORMATION FOR DUE TO CUSTOMER TYPE CHANGE & RECEIVABLE AMOUNT FOR THE MONTH OF "+bill_year;
			}
		}
...
private void generatePdfNonmeteredCustomer(Document document) throws DocumentException{
	...
	private ArrayList<DisconnectDTO> getdisconnectionListArrear(){
		...
		try {
			...
			String disconnection_info_sql="SELECT bqc.CUSTOMER_ID, " +
					...
					" 		WHERE     bqc.customer_id = cpi.customer_id and substr(CPI.CUSTOMEr_ID,3,2)=MCC.CATEGORY_ID " +wClause+w2Clause+w3Clause+
	...
	private ArrayList<DisconnectDTO> getdisconnectionListMetered(){
		...
		try {
			...
			if(report_for.equals("area_wise")){
				...
				wClause="AND SUBSTR(CPI.CUSTOMER_ID,1,2)="+area+"AND SUBSTR(CPI.CUSTOMER_ID,3,2)="+customer_category;
			}
			...
			if(disconnect_type_m.equals("01")){
				w3Clause=" DISCONNECT_CAUSE = 0 ";
			}else if(disconnect_type_m.equals("02")){
				w3Clause=" DISCONNECT_CAUSE = 1 ";
			}else if(disconnect_type_m.equals("03")){
				w3Clause=" DISCONNECT_CAUSE = 2 ";
			}else if(disconnect_type_m.equals("04")){
				w3Clause=" DISCONNECT_CAUSE = 4 ";
			}else if(disconnect_type_m.equals("05")){
				w3Clause=" DISCONNECT_CAUSE = 5 ";
			}else if(disconnect_type_m.equals("06")){
				w3Clause=" DISCONNECT_CAUSE = 6 ";
			}
			...
			String disconnection_info_sql="select bm.CATEGORY_TYPE,bm.CUSTOMER_CATEGORY,bm.CUSTOMER_CATEGORY_NAME, FULL_NAME,CPI.CUSTOMER_ID,to_char(DM.DISCONNECT_DATE) DISCONNECT_DATE,BM.MINIMUM_LOAD,MR.CURR_READING,MR.PREV_READING, " +
					...
					"	where "+w3Clause+wClause+w2Clause+
	...
	public String getDisconnect_type_m() {
		return disconnect_type_m;
	}

	public void setDisconnect_type_m(String disconnect_type_m) {
		this.disconnect_type_m = disconnect_type_m;
	}
