...
public class NonMeterDisconnectionReport extends BaseAction {
	...
	//PreparedStatement ps1=null;
		...
		try {
			...
			String defaulterSql="SELECT CAST(to_char(LAST_DAY(to_date('01-'||to_char(to_date(DISCONNECT_DATE,'dd-MM-YYYY'), 'mm')||'-'||to_char(to_date(DISCONNECT_DATE,'dd-MM-YYYY'), 'YYYY'),'dd-MM-YYYY')),'dd') AS INT) LASTDAY, " +
					"         dm.CUSTOMER_ID, " +
					"         mci.FULL_NAME, " +
					"         mci.CATEGORY_ID, " +
					"         mci.CATEGORY_NAME, " +
					...
					"ORDER BY DISCONNECT_DATE_ORDER ASC " ;
