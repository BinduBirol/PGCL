...
public class MeteredBillFormatWithData extends PdfPageEventHelper { 
	...
	public static void createStationary(String filename) throws IOException,
		...
		pcell = new PdfPCell(new Paragraph("May, 2015", f11));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setFixedHeight(20);
		...
		pcell = new PdfPCell(new Paragraph("Commercial ( PVT. ) Gas Bill",f11B));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setFixedHeight(20);
		...
		pcell = new PdfPCell(new Paragraph("010212345", f11));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setFixedHeight(18);
		...
		pcell = new PdfPCell(new Paragraph("Md. Shah Alam", f11));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setFixedHeight(18);
		...
		pcell = new PdfPCell(new Paragraph("IICT, BUET", f11));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setFixedHeight(18);
		...
		pcell = new PdfPCell(new Paragraph("01799898787", f11));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setFixedHeight(18);
		...
		pcell = new PdfPCell(new Paragraph("Due Date(without surcharge)", f11));
		pcell.setBorderColor(BaseColor.BLACK);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setFixedHeight(22);
		...
		pcell = new PdfPCell(new Paragraph("Monthly Minimum Load", f11));
		pcell.setBorderColor(BaseColor.BLACK);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setFixedHeight(22);
		...
		pcell = new PdfPCell((new Paragraph("Rate per SCM (TK)", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setRowspan(2);
		MeterReadingTable.addCell(pcell);
		...
		pcell = new PdfPCell((new Paragraph("HHV/NHV", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		MeterReadingTable.addCell(pcell);

		
		pcell = new PdfPCell((new Paragraph("27676765654", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		pcell = new PdfPCell((new Paragraph("3273309", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		pcell = new PdfPCell((new Paragraph("3560663", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		pcell = new PdfPCell((new Paragraph("287354", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		pcell = new PdfPCell((new Paragraph("15.00", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		...
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		pcell = new PdfPCell((new Paragraph("2.018", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		...
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		pcell = new PdfPCell((new Paragraph("5.16", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setFixedHeight(22);
		MeterReadingTable.addCell(pcell);
		...
		pcell = new PdfPCell((new Paragraph("Other Consumption (2)     :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT);
		...
		pcell = new PdfPCell((new Paragraph("Mixed Consumption (3)     :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT);
		...
		pcell = new PdfPCell((new Paragraph(
				"Total Billed Quantity (1+2+3)     :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT);
		...
		pcell = new PdfPCell((new Paragraph(
				"HHV/NHV Adjustment Quantity     :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		...
		pcell = new PdfPCell((new Paragraph("A) Government Margin(55%)", f11B)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT );
		...
		pcell = new PdfPCell((new Paragraph("Amount(Taka)", f11B)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setBorder(Rectangle.NO_BORDER);
		...
		pcell = new PdfPCell((new Paragraph("Value Added Tax (VAT)     :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT);
		...
		pcell = new PdfPCell((new Paragraph("Suplimentary Duty (SD)     :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT);
		...
		pcell = new PdfPCell((new Paragraph("IOC Pay Fund/Others     :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT);
		...
		pcell = new PdfPCell((new Paragraph("Sub Total (A) =", f11B)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT | Rectangle.BOTTOM);
		...
		pcell = new PdfPCell((new Paragraph("B) PB's Margin (45%)     ", f11B)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setPaddingLeft(10);
		pcell.setFixedHeight(22);
		...
		pcell = new PdfPCell((new Paragraph("Gas Bill    :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setPaddingRight(10);
		...
		pcell = new PdfPCell((new Paragraph("Bill for Minimum Load    :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setPaddingRight(10);
		pcell.setBorder(Rectangle.NO_BORDER | Rectangle.TOP);
		...
		pcell = new PdfPCell((new Paragraph("Meter/CMS Rent    :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setPaddingRight(10);
		pcell.setBorder(Rectangle.NO_BORDER | Rectangle.TOP);
		...
		pcell = new PdfPCell((new Paragraph("Bill Due to HHV/NHV    :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setPaddingRight(10);
		pcell.setBorder(Rectangle.NO_BORDER | Rectangle.TOP);
		...
		pcell = new PdfPCell((new Paragraph("Adjustment    :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setPaddingRight(10);
		pcell.setBorder(Rectangle.NO_BORDER | Rectangle.TOP);
		...
		pcell = new PdfPCell((new Paragraph("Others    :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setPaddingRight(10);
		pcell.setBorder(Rectangle.NO_BORDER);
		...
		pcell = new PdfPCell((new Paragraph("VAT Rebate @      %    :", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setPaddingRight(10);
		pcell.setBorder(Rectangle.NO_BORDER | Rectangle.TOP);
		...
		pcell = new PdfPCell((new Paragraph("Sub Total (B) =", f11B)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT | Rectangle.BOTTOM);
		...
		pcell = new PdfPCell(
				(new Paragraph("Total Payable Amount (A+B) =", f11B)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(Rectangle.NO_BORDER);
		pcell.setBorder(Rectangle.LEFT | Rectangle.BOTTOM);
		...
		pcell = new PdfPCell((new Paragraph(
				"In Words : Taka (One Thousand) Only.", f11B)));
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setPaddingLeft(10);
		pcell.setFixedHeight(25);
		...
		pcell = new PdfPCell((new Paragraph(
				"Arrear Bill Information (Without Surcharge)", f11)));
		pcell.setVerticalAlignment(Element.ALIGN_TOP);
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setPaddingLeft(10);
		...
		jpeg_header_bangla.setAbsolutePosition(218, 820);
		document.add(jpeg_header_bangla);

		jpeg_note_line1.scalePercent(50f);
		jpeg_note_line1.setAbsolutePosition(30, 138);
		document.add(jpeg_note_line1);

		jpeg_note_line2.scalePercent(50f);
		jpeg_note_line2.setAbsolutePosition(30, 125);
