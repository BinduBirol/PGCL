...
public class MinistryWiseDueReportHeadOfice extends BaseAction {
	...
	Connection conn = ConnectionManager.getConnection();
		...
		public String execute() throws Exception {
			...
			try{
				...
				{
					pcell=new PdfPCell(new Paragraph("STAEMENT SHOWING THE ARREAR AMOUNT TO DIFERENT CATEGORIES FOR THE PERIOD OF "+from_date+" To "+to_date,ReportUtil.f11B));
					pcell.setMinimumHeight(18f);
					pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
					pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
					pcell.setBorder(0);
		...
		private ArrayList<MinistryDTO> getMinistryData(){
			...
			try {
				...
				String[] toDate=to_date.split("-");
					...
					if(report_for.equals("area_wise"))
					{
						wClause=" order by  MINISTRY_ID,MM.CUSTOMER_ID desc ";
					}else if(report_for.equals("category_wise"))
					{
						wClause="  order by  MM.CUSTOMER_ID";
					}else if(report_for.equals("ministry_wise"))
					{
						wClause=" AND MINISTRY_ID='"+customer_ministry+"' order by MM.CUSTOMER_ID";
					}
	            
	            
				String disconnection_info_sql="SELECT MM.CUSTOMER_ID,CATEGORY_NAME,CATEGORY_ID,FULL_NAME,ADDRESS_LINE1,OPENING_BALANCE/100000 OPENING_BALANCE,TOTAL_SALES/100000 TOTAL_SALES,TOTAL_COLLECTION/100000 TOTAL_COLLECTION,CLOSING_BALANCE/100000 CLOSING_BALANCE,nvl(TOTAL_DUE_MONTH,0) TOTAL_DUE_MONTH,ISMETERED,STATUS, " +
						...
						"where substr(CUSTOMER_ID,3,2) in ('02','04','06','12') " +
						...
						"and SUBSTR(CC.CUSTOMER_ID,3,2) in ('02','04','06','12')) BB " +
                        ...
                        "     WHERE     SUBSTR (customer_id, 3, 2) IN ('02','04','06','12')) BB " +
