...
public class GasPurchaseService {
	public ResponseDTO saveGasPurchaseInfo(GasPurchaseDTO gasPurchaseinfo)
	{
		...
		DecimalFormat consumption_format = new DecimalFormat("##.000");
		try
			{
...
//					stmt.setDouble(i++,Math.round(gasPurchaseinfo.getBgfcl_power_gvt()*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl())));
					...
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_power_gvt()+gasPurchaseinfo.getBgfcl_power_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_captive_gvt()+gasPurchaseinfo.getBgfcl_captive_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_cng_gvt()+gasPurchaseinfo.getBgfcl_cng_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_industry_gvt()+gasPurchaseinfo.getBgfcl_industry_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_comm_gvt()+gasPurchaseinfo.getBgfcl_comm_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_dom_meter_gvt()+gasPurchaseinfo.getBgfcl_dom_meter_pvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_gvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_fertilizer_gvt()*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_fertilizer_pvt()*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_tea_gvt()*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_tea_pvt()*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
...
//					stmt.setDouble(i++,gasPurchaseinfo.getBgfcl_tea_pvt()*sgfl__ratio);
					...
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_power_gvt()+gasPurchaseinfo.getBgfcl_power_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_captive_gvt()+gasPurchaseinfo.getBgfcl_captive_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_cng_gvt()+gasPurchaseinfo.getBgfcl_cng_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_industry_gvt()+gasPurchaseinfo.getBgfcl_industry_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_comm_gvt()+gasPurchaseinfo.getBgfcl_comm_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_dom_meter_gvt()+gasPurchaseinfo.getBgfcl_dom_meter_pvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_gvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,0.0);
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_fertilizer_gvt()*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_fertilizer_pvt()*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_tea_gvt()*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format(gasPurchaseinfo.getBgfcl_tea_pvt()*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					...
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_comm_gvt()+gasPurchaseinfo.getBgfcl_comm_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_dom_meter_gvt()+gasPurchaseinfo.getBgfcl_dom_meter_pvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_gvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_fertilizer_gvt()+gasPurchaseinfo.getBgfcl_fertilizer_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_tea_gvt()+gasPurchaseinfo.getBgfcl_tea_pvt())*(gasPurchaseinfo.getTotal_bgfcl()/gasPurchaseinfo.getTotal_gtcl()))));
					...
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_comm_gvt()+gasPurchaseinfo.getBgfcl_comm_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_dom_meter_gvt()+gasPurchaseinfo.getBgfcl_dom_meter_pvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_gvt()+gasPurchaseinfo.getBgfcl_dom_nmeter_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_fertilizer_gvt()+gasPurchaseinfo.getBgfcl_fertilizer_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
					stmt.setDouble(i++,Double.parseDouble(consumption_format.format((gasPurchaseinfo.getBgfcl_tea_gvt()+gasPurchaseinfo.getBgfcl_tea_pvt())*(gasPurchaseinfo.getTotal_sgfl()/gasPurchaseinfo.getTotal_gtcl()))));
