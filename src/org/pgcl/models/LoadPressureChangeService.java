...
import org.pgcl.actions.connection.LoadPressureChange;
...
//			return response;
		...
		PreparedStatement stmt = null;
			try
			{
				...
				stmt.setFloat(18,reading.getMeter_rent());
				stmt.setFloat(19,reading.getPressure());
				stmt.setDouble(20,reading.getPressure_factor());
				stmt.setFloat(21,reading.getTemperature());
				...
				stmt.setFloat(25,propMinLoad);
				stmt.setFloat(26,propMaxLoad);
				stmt.execute();
