...
public class UserService {
	...
	{	
		...
		boolean passOk=false;
			   ...
			   sql= " Select USERID,PASSWORD,USERNAME,ROLE_ID,ROLE_NAME,AREA_ID,AREA_NAME,BRANCH_ID,ORG_DIVISION.DIVISION_ID ORG_DIVISION_ID,ORG_DIVISION.DIVISION_NAME ORG_DIVISION_NAME, " +
		   ...
		   ResultSet r = null;
			...
			try
			{
				...
				if (r.next())
				{
					...
					user.setBranch_id(r.getString("BRANCH_ID"));
