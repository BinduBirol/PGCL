			...
			<form id="meterForm" name="meterForm" style="margin-bottom: 1px;">
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<input type="text" id="comment" style="width: 40%" maxlength="1000" tabindex="101" />
					</div>	
					<div class="span12">
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/securityAdjustment.js"></script>
<script>
