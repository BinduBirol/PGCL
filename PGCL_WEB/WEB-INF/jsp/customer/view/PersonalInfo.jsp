        ...
        <div class="span4">
            <div class="row-fluid" style="display: none;">
                <div style="width: 110px;height:137px;border: 1px solid black;float: left;" class="span6" id="customer_photo">
                	<img id='img_photo' src="http://localhost/PGCL_PHOTO/customer/<s:property value='customer.customer_id'/>.jpg" />
                </div>
                 <div style="float: left;margin-top: 125px;display: none;">
							...
							<div id='outer_container' class="outer_container" >
								...
								<ul class="menu_option">								  
								  ...
								  <!-- 
								  <li><a href="#" onclick="pieMenuCall('load_change')"><span style="background: url('/PGCL_WEB/resources/thirdParty/pieMenu/img/customer.png') no-repeat scroll center center / 16px 16px transparent;">Item</span></a></li>
								   -->
								</ul>
							</div>				
						</div>                
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/pieMenu.js"></script>
<script type="text/javascript">
$('#img_photo').safeUrl({wanted:"http://localhost/PGCL_PHOTO/customer/<s:property value='customer.customer_id'/>.jpg",rm:"http://localhost/PGCL_PHOTO/anon_user.png"});
