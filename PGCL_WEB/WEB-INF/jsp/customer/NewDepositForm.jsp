...
<%@ taglib prefix="s" uri="/struts-tags"%>
			...
			<div class="row-fluid" id="account_info">
				  ...
				  <div class="span4">
						...
						<select name="deposit.branch" id="branch_id"  style="width: 59%" onchange="fetchSelectBox(account_sbox);">
                                <option value="" selected="selected">Select Branch</option>
                        </select>
				  </div>	
				  <div class="span4">
					  <label>Account</label>
					  <select name="deposit.account_no" id="account_id"  style="width: 59%">
			...
			<div class="row-fluid">	         	  
                  ...
                  <div class="span4">
                  	...
                  	<input type="text" name="deposit.total_deposit" id="total_deposit" style="width: 54%;border: 1px dotted magenta;text-align: right;font-weight: bold;" readonly="readonly" value="<s:property value='deposit.total_deposit' />"/>
                  </div>							                               
			</div>
...
var account_sbox = { targetElm :"account_id",/* zeroIndex : 'Select Account', */action_name:'fetchAccounts.action?type=securityAccount',data_key:'branch_id'};
