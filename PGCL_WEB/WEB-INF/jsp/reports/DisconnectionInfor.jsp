		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
     				...
     				<form id="billProcessForm" name="billProcessForm" action="disconnInfo.action" style="margin-bottom: 1px;">
						<div class="row-fluid">
							<div class="span12">
						...
						<div class="row-fluid" id="disconnect_div_meter">							
							<div class="span6">									    
								<label style="width: 40%">Disconnect Type</label>
								<select id="disconnect_type_m" style="width: 56%;"   name="disconnect_type_m" ">
									<option value="" >Select Category</option>									
										<option value="01"  selected="selected">Illegal Connection</option>
										<option value="02" >Gas Bill Due</option>
										<option value="03" >Applied By Customer</option>
										<option value="04" >Due to natural calamity</option>
										<option value="05" >Due to Govt Transfer</option>
										<option value="06" >Customer Type Change</option>		
								</select>  								      
							</div>
							 
						</div>
						
						<div class="row-fluid" id="disconnect_div">							
							<div class="span6">									    
								<label style="width: 40%">Disconnect Type</label>
								<select id="disconnect_type" style="width: 56%;"   name="disconnect_type" ">
									<option value="" >Select Category</option>									
										<option value="01"  selected="selected">Arrear</option>
										<option value="02" >Illigal</option>
										<option value="03" >Applied By Customer</option>
										<option value="04" >Due to Govt. Transfer</option>		
								</select>  								      
							</div>
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/disconnectReport.js"></script>	
