...
/* 	$(".addCF").click(function(){
    ...
    $(".lessCF").click(function(){
		$("#lessTable").append('<tr valign="top"><td width="75%"><div class="select-editable"><select name="lessComment[]"  style="width:40%;" ><option value="">Cause</option> <s:iterator  value="%{#application.ALL_RECONCILIATION_CAUSE_LESS}">   <option value="<s:property value='label'/>"><s:property value="label"/></option></s:iterator></select> <input type="text" name="lessAccount[]" value=""  style="width:25%;text-align:right;padding-right:0px;" />     <input type="text" name="lessAmount[]" value=""  style="width:15%;text-align:right;padding-right:0px;" onkeyup="calcuateTotalOthersAmount()"/> &nbsp; <a href="javascript:void(0);" class="remCF"><img src="/PGCL_WEB/resources/images/delete_16.png" /></a></div></td></tr>');
	});
...
function saveReconcilationInfoAndPrint(){
	...
	var lessComment = $("select[name='lessComment\\[\\]']").map(function(){return $(this).val();}).get();
	var lessAmount = $("input[name='lessAmount\\[\\]']").map(function(){return $(this).val();}).get();
	var addAccount=$("input[name='addAccount\\[\\]']").map(function(){return $(this).val();}).get();
	var lessAccount=$("input[name='lessAccount\\[\\]']").map(function(){return $(this).val();}).get();
	calcuateTotalOthersAmount();
