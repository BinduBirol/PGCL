...
<script  type="text/javascript">
	navCache("areaSecurityHome.action");
	setTitle("Area wise Security Report Generation");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Area Wise Security Report</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="areaSecurityInfo.action" style="margin-bottom: 1px;">
						<div class="row-fluid" >
							<div class="span12">
