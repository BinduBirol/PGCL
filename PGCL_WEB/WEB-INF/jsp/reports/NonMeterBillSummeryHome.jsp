...
<script  type="text/javascript">
	navCache("nonMeterBillingSummeryHome.action");
	setTitle("Non-Meter Bill Summery");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Non-Meter Billing Summary</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="nonMeterBillSummeryReport.action" style="margin-bottom: 1px;">
						<div class="row-fluid">
							<div class="span12">
						...
						<div class="row-fluid">							
							<div class="span6">									    
								...
								<select name="billing_month" id="billing_month" style="width: 56%;margin-left: 0px;">
							...
							<div class="span6">
								...
								<select name="billing_year" id="billing_year" style="width: 56%;">
