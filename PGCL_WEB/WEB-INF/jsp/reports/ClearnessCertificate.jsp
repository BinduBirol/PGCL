				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
					...
					<div id="download_div">
     				<form id="billProcessForm" name="billProcessForm" action="clearnessCertificateInfo.action" style="margin-bottom: 1px;">
						...
						<div class="row-fluid" id="customer_due_div" style="display: none">							
							<div class="span12">									    
								<label style="width: 40%">Due Status</label>
								<select id="due_status" style="width: 56%;"   name="due_status" ">
									<option value="" >Select Status</option>									
										<option value="01"  selected="selected">Without-Due</option>
										<option value="02" >Due</option>		
								</select>  								      
							</div>	 
						</div> 					
...
function checkType(type){
	...
	{
	hideElement("approve_div","category_div","range_code_div","customer_type_div","calender_year_div","customer_due_div");
	showElement("download_div","individual_code_div","print_download");
	 ...
	 showElement("download_div","category_div","range_code_div","customer_type_div","calender_year_div","print_download","customer_due_div");
