...
<script  type="text/javascript">
	navCache("vatRebatejvHome.action");
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">VAT Rebate Journal Voucher</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="vatRebatejvInfo.action" style="margin-bottom: 1px;">
