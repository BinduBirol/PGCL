...
<script  type="text/javascript">
	navCache("securityNoticeHome.action");
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
     				...
     				<form id="billProcessForm" name="billProcessForm" action="securityNoticeInfo.action" style="margin-bottom: 1px;">
										
						
						<div class="row-fluid">
							<div class="span12" style="margin-top: 4px;">
								<label style="width: 19.5%">Customer ID <m class='man'/></label>
								<input type="text" name="customer_id" id="customer_id" style="font-weight: bold;color: #3b5894;position: absolute; z-index: 2; background: transparent;width: 36.5%;margin-top: -4px;" value="<s:property value='customer_id' />" tabindex="1"/>
						...
						<div class="row-fluid">
							<div class="span12">
								<label style="width: 19.5%">Period Limit <m class='man'/></label>
								<input type="text" name="time_limit" id="time_limit" style="font-weight: bold;color: #3b5894;position: absolute; z-index: 2; background: transparent;width: 36.5%;margin-top: -4px;" value="">
