...
<script  type="text/javascript">
	navCache("ministryReportHome.action");
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
     				...
     				<form id="billProcessForm" name="billProcessForm" action="ministryReportInfo.action" style="margin-bottom: 1px;">
						<div class="row-fluid">
							<div class="span12">
									...
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="right" style="font-size: 12px;font-weight: bold;">
												<input type="radio" value="category_wise" id="by_category" name="report_for" onclick="checkType(this.id)" checked/> Cust. Wise Details&nbsp;&nbsp;&nbsp;
												<input type="radio" value="area_wise" id="area_wise" name="report_for" onclick="checkType(this.id)"/> Ministry Wise Details&nbsp;&nbsp;&nbsp;												
												<input type="radio" value="ministry_wise" id="by_ministry" name="report_for" onclick="checkType(this.id)" /> Single Ministry&nbsp;&nbsp;&nbsp;
						...
						<div class="row-fluid" id="ministry_div">	
							<div class="span6">
								<label style="width: 40%">Ministry<m class='man'/></label>
								<select id="customer_ministry" style="width: 56%;" disabled="disabled"  name="customer_ministry" onchange="fetchCategoryName()">
							...
							<!--<div class="row-fluid" id="category_div">
							   <div class="span6">
								<label style="width: 40%">Select Category<m class='man'/></label>
