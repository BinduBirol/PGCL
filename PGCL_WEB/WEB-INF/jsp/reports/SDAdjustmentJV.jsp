...
<script  type="text/javascript">
	navCache("sdAdjustmentjvHome.action");
	setTitle("Security JV Generation");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Security Adjustment Journal Voucher</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="sdAdjvInfo.action" style="margin-bottom: 1px;">
						...
						<div class="row-fluid" id="month_year_div" style="display:none">							
							<div class="span6" id="month_div">									    
								<label style="width: 40%">Adjustment Month<m class='man'/></label>
							...
							<div class="span6" id="year_div">
								<label style="width: 40%">Adjustment Year<m class='man'/></label>
