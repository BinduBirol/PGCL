			...
			<legend>Add</legend>
						...
						<table  id="addTable" style="width: 100%">
						 	<tr valign="top">
								...
								<td width="75%">
									<div style='width:30%;float:left;padding-left:5px;font-weight:bold;'>Title</div>
									<div style='width:30%;float:left;padding-left:8%;font-weight:bold;'>Account No</div>
									<div style='width:20%;float:left;padding-left:8%;font-weight:bold;'>Amount</div>
