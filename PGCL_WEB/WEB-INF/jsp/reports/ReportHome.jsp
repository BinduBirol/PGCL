...
<link href="/PGCL_WEB/resources/css/template/report.css" rel="stylesheet" type="text/css" />
<div class="row-fluid">							
	<div class="span3">	
		<div class="report">
		  <div class="box-collection">
		    <ul class="column">
				<s:if test="%{reportType=='sales'}">
					...
					<li class="boxG" onclick="ajaxLoad('report_input_div','nonmeterLoadIncreaseHome.action')"><span>Load Increase Information</span> </li>
				...
				<s:if test="reportType=='collection'">
					...
					<li class="boxV" onclick="ajaxLoad('report_input_div','ministryReportHome.action')"><span>Ministry Wise Govt. Due List</span> </li>
					<li class="boxV" onclick="ajaxLoad('report_input_div','ministryReportHomeHO.action')"><span>Govt. Due List(Head Office)</span> </li>
				</s:if>
				<s:if test="reportType=='journal'">
					...
					<li class="boxY" onclick="ajaxLoad('report_input_div','sdAdjustmentjvHome.action')"><span>Security Adjustment JV</span> </li>
					</s:if>
				...
				<s:if test="reportType=='others'">
					...
					<li class="boxY" onclick="ajaxLoad('report_input_div','certificationSummeryHome.action')"><span>Certification Summary</span> </li>
