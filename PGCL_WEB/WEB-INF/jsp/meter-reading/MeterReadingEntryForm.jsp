...
<div class="row-fluid">
	<div class="span6">
		...
		<input type="text" onblur="checkInput(this.id)"  name="reading.customer_id" id="customer_id" class="mr_1row_text"  style="font-weight: bold;color: #3b5894;position: absolute; z-index: 2; background: transparent;margin-top: -4px;" value="<s:property value='customer_id' />" tabindex="1"/>
	...
	<div class="span6">									    
		<label class="mr_lable">Area-Category</label>
...
<div class="row-fluid">    
	<div class="span6">
		<label class="mr_lable">Meter<m class='man'/></label>
		<select name="reading.meter_id" id="meter_id" class="mr_select" onchange="fetchReadingInfo(readingCallBack)" disabled="disabled" style="width:62%;">
...
<div class="row-fluid"> 
   ...
   <div class="span6">
       <label class="mr_lable">C. Reading Date</label>
...
<div class="row-fluid">    
   ...
   <div class="span6">
       ...
       <input type="text" name="reading.hhv_nhv" id="hhv_nhv"  class="mr_text" disabled="disabled" style="width: 59%;"/>									       
   </div>
</div>
...
<div class="row-fluid"> 
   <div class="span6">
       ...
       <input type="text" name="reading.measurement_type_name" id="measurement_type_name"  class="mr_text1" disabled="disabled" style="width: 29%;"/>
       <input type="hidden" name="reading.measurement_type_str" id="measurement_type_str" />
       <input type="text" name="reading.rate" id="rate"  class="mr_text2" disabled="disabled" style="width: 25%;"/>
       <input type="hidden" name="reading.tariff_id" id="tariff_id" />
       <input type="hidden" name="reading.latest_tariff_id" id="latest_tariff_id" />
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/meterReadingEntryForm.js"></script>					
