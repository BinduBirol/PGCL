...
<script  type="text/javascript">
	navCache("billCreationHome.action?bill_parameter.isMetered_str=installment");
	setTitle("Installment Bill Printing");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Installment Bill Printing</h4>
				</div>
						   ...
						   <table width="100%">
						   	<tr>
						   		...
						   		<td style="width: 70%" align="right">
						   			<button class="btn btn-primary" type="button" id="btn_parameter" onclick="reloadBillGrid()">Show Bills</button>
						   		</td>
						   	</tr>
						   </table>								    
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/installmentBillPrinting.js"></script>	
