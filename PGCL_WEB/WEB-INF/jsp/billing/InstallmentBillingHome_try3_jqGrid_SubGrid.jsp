...
.ui-datepicker-calendar{
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {
                ...
                if(a!=""){                
					 ...
					 html +=  		 '       	<tr>  '  + 
							 ...
							 '               <td>$50</td>  '  + 
							 '               <td>Bob</td>  '  + 
							 '               <td><a href="javascript:void(0);" id="x1" onclick="deleteRow(\'x1\')" class="remCF"><img src="/PGCL_WEB/resources/images/delete_16.png" /></a></td> '+
							 '           </tr>  ';
				...
				html+=getNewRow();
						...
						html+='       </tbody>  '  + 
							 '  </table>  '+
							 '   <div style="float:left;padding:10px;"><a href="javascript:void(0);" onclick="addInstallmentDetailRow(\''+tableId+'\')"><img src="/PGCL_WEB/resources/images/icons/plus.png" /></a></div> '; 
   ...
   function getNewRow(){
   	return '       	<tr>  '  + 
							 ...
							 '               <td style="text-align:center;"><input type="text" id="" style="width:80px;text-align:right;" /></td>  '  + 
							 '               <td style="text-align:center;"><input type="text" id="" style="width:80px;text-align:right;" /></td>  '  +
							 '               <td style="text-align:center;"><a href="javascript:void(0);" id="x1" onclick="deleteRow(\'x1\')" class="remCF"><img src="/PGCL_WEB/resources/images/delete_16.png" /></a></td> '+
							 '           </tr>  ';
   }
