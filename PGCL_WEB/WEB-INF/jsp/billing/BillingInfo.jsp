...
<div style="margin-top: 20px;">
	<s:if test="customer.connectionInfo.isMetered.label==@org.pgcl.enums.MeteredStatus@METERED.label">
			<s:if test="mBilling==null">
			 Bill for this Customer has not been generated yet.<br/><br/>
			 If you like to get a preview of the bill, please click here - <br/><br/>			 
			 <a href="#" onclick="generateBill()">Generate Bill</a>
			</s:if>
			<s:else>
				<p class="formSep" style="padding: 0px;">
					<div style="float:left;width:50%">
					<label class="muted" style="width: 25%">Customer Id</label>
					<font style="font-size: 18px;font-weight: bold;"><s:property value="mBilling.customer_info.customer_id"/></font>
					</div>
					<div style="float:left;width:50%;">
					<label class="muted" style="width: 25%;">Full Name</label>
					<s:property value="mBilling.customer_info.customer_id"/>
					</div>
				</p>
				<p class="formSep" style="padding: 0px;">
				<div style="float:left;width:50%">
			...
			<div class="tabbable tabbable-bordered">
                         ...
                         <div id="tb3_b" class="tab-pane">                             
                             ...
                             <table width="100%" style="border-collapse: collapse;" border="0">
                             	...
                             	<tr>
                             		...
                             		<td class="tdS1">Pre. Reading</td><td><s:property value='prev_reading' /></td>
           		...
           		<button class="btn btn-success" type="button" onclick="window.location='downloadMeteredBill.action'">Download (PDF)</button>
			</s:else>
	</s:if>
	<s:if test="customer.connectionInfo.isMetered.label==@org.pgcl.enums.MeteredStatus@NONMETERED.label">
		<p class="formSep" style="padding: 0px;">
	...
	<p class="formSep" style="padding: 0px;padding-top: 10px;">
		...
		<s:if test="nmBilling.str_status==@org.pgcl.enums.BillStatus@INITIALIZED.label">
			<button class="btn btn-primary disabled" type="button">Initialize</button>
			<button class="btn btn-danger">Process</button>
			<button class="btn btn-success">Download (PDF)</button>
		</s:if>
		<s:if test="nmBilling.str_status==@org.pgcl.enums.BillStatus@PROCESSED.label">
			<button class="btn btn-primary disabled" type="button">Initialize</button>
			<button class="btn btn-danger disabled" type="button">Process</button>
			<button class="btn btn-success">Download (PDF)</button>
		</s:if>
...
function generateBill()
{
   $.ajax({
   		  type: 'POST',
   		  url: 'generateBill.action',
   		  data: { meter_status:'Metered',customer_id:$("#customer_id").val()},
