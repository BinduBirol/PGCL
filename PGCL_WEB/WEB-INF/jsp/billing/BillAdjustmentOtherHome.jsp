				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">												
						...
						<div class="row-fluid">
							<div class="span12">
								...
								<input type="radio" name="operationType" id="adjustment" value="adjustment" checked="checked" onclick="changeSelection(this.value)"/>&nbsp;&nbsp;Surcharge Adjustment
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;								
...
function loadUnpaidBillList(){
	if($("#customer_id").val()=="") return;
   	var ruleArray=[["customer_id","status"],["eq","eq"],[$("#customer_id").val(),"0"]];
...
$("#unpaid_bill_grid").jqGrid($.extend(true, {}, scrollPagerGridOptions, {
	url: jsEnum.GRID_RECORED_FETCHER+'?service=org.pgcl.models.BillingService&method=getBillList',
   	jsonReader: {
            repeatitems: false,
            id: "bill_id"
	},
