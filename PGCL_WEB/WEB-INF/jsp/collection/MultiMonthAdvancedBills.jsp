	...
	<div class="ui-jqgrid-bdiv" style="width: 778px;height: 100%;padding: 5px;">
			<div class="row-fluid" style="margin-top: 10px;">
					<div class="span12">
						<div class="row-fluid">
							<div class="span6">
								<label style="width: 20%;padding-left: 10px;">From</label>
								<input type="text" id="from_date" tabindex="1" style="width: 60%"/>							
						  	</div>
						  	<div class="span6">									    
								<label style="width: 20%">To</label>
								<input type="text" id="to_date" tabindex="1" style="width: 60%"/>							
							</div>
						</div>				                                            					                                            
						<div class="row-fluid">
							<div class="span6">
						  	...
						  	<div class="span6">									    
								<button class="btn btn-beoro-3"  type="button" id="btn_cancel" onclick="addAdvanceCollectionRow()">
