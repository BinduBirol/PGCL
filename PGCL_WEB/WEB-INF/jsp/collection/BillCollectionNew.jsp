...
<script type="text/javascript" src="/PGCL_WEB/resources/thirdParty/popupModal/ns-window.js"></script>
<link href="/PGCL_WEB/resources/thirdParty/popupModal/css/ns-window.css" rel="stylesheet" />
<link href="/PGCL_WEB/resources/css/page/billCollection.css" rel="stylesheet" type="text/css" />
<style>
     				...
     				<form id="billCollectionForm" name="billCollectionForm">	
     					<div class="row-fluid">
							<div class="span6">									    
						  	...
						  	<div class="span6" style="background: #FFFFCC;padding: 4px;">									    
						...
						<div class="row-fluid">							
							...
							<div class="span6" style="background: #FFFFCC;padding: 4px;">									    
								<label style="width: 40%">Total Bill Amount</label>
								<input type="text" name="collection.surcharge_amount"  
								id="surcharge_amount" tabindex="3" 
								style="text-align: right;color: blue;width: 51%;border: none;border-bottom: 2px dotted black;background: transparent;" 
								readonly="readonly"/>								
							</div>
						...
						<div class="row-fluid">							
							...
							<div class="span6" style="background: #99FFFF;padding: 4px;">
								<label style="width: 40%">Partial Collected</label>
								<input type="text" name="aa"  id="aa" tabindex="3" style="text-align: right;color: blue;width: 51%" readonly="readonly"/>
							</div> 						
						</div>
						...
						<div class="row-fluid">							
							<div class="span6">
								...
								<input type="hidden" name="collection.customer_id" id="customer_id" />								
						  	</div>
						...
						<div class="row-fluid">							
							...
							<div class="span6" style="background: #99FFFF;padding: 4px;">									    
								<label style="width: 40%">Total Deduction</label>
								<input type="text" name="collection.surcharge_amount"  
								id="surcharge_amount" tabindex="3" 
								style="text-align: right;color: blue;width: 51%;border: none;border-bottom: 2px dotted black;background: transparent;" 
								readonly="readonly"/>								
						...
						<div class="row-fluid">
						    <div class="span6">									    
								...
								<input type="text" style="width: 51%;background-color:#FDEEF4;color: black;font-weight: bold;"  id="mobile" name="collection.mobile" />
						...
						<div class="row-fluid">
							...
							<div class="span6" style="background: #CCFFCC;padding: 4px;">
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/collection.js"></script>
