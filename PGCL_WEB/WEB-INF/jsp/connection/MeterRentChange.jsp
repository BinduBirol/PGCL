...
<script  type="text/javascript">
	navCache("meterRentChangeHome.action");
	setTitle("Meter Rent Change Information");
</script>
...
<div style="width: 51%; height: 99%;float: left;margin-left: 1%;">
	<div class="row-fluid">
		<div class="span12" id="rightSpan">					
				<jsp:include page="MeterRentChangeInfo.jsp" />	
		</div>
	</div>	
</div>
</div>
...
<div id="tabbed-nav">
            <ul>
                <li><a>All Metered Customer</a></li>
                <li><a>Rent Change History (<font color="green" style="font-weight: bold;">For this customer</font>)</a></li>
                <li><a>Rent Change History(<font color="#E42217" style="font-weight: bold;">All Customer</font>)</a></li>
            </ul>
            <div>
                <div>
                ...
                <div>
                    <table id="meterRent_change_history_all_grid"></table>
					<div id="meterRent_change_history_all_grid_pager" ></div>
                </div>
            </div>
...
<script type="text/javascript" src="/PGCL_WEB/resources/js/page/meterRentChange.js"></script>
