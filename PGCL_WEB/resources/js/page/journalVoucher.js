...
function fetchCollectionInfo()
{
	...
	if($("#old_customer_id").val()=="" || $("#bill_month").val()=="" || $("#bill_year").val()=="")
 	...
 	$.ajax({
   		  type: 'POST',
   		  url: 'getCollectionInfoByCustomerIdBillingMonthYear.action?collection.customer_id='+$("#old_customer_id").val()+'&collection.bill_month='+$("#bill_month").val()+'&collection.bill_year='+$("#bill_year").val()+'&collection.collection_date='+$("collection_date").val(),
