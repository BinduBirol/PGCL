...
jQuery("#gridTable")
    .jqGrid({
        ...
        colNames: ['ID','Tariff No', 'Category','Meter Status','Burner Category','Description','Price','PB','VAT','SD','PDF','Bapex','Wellhead','Dwellhead','Trasmission','Gdfund','Distribution','Shortfall','Effective From','Effective To','Action'],
        colModel: [{
		                name: 'tariff_id',
		                index: 'tariff_id',
		                editable: true,
