...
$("#meter_grid").jqGrid($.extend(true, {}, scrollPagerGridOptions, {
    ...
    colNames: ["Meter No","Installed on","Status","Customer Id","Meter Rent","Meter Mfg.","Year","Meter Type","conn_size","G-Rating","Measurement Type","Max. Reading","Ini.Reading","Pressure","Temperature","Remarks","Meter Id","Installed by","Installed by name","EVC Serial","EVC Year","EVC Model"],
    colModel: [
            	{
	                name: 'meter_sl_no',
	                index: 'meter_sl_no',
