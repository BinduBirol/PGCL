    ...
    colModel: [{
            	...
            	},
            	{
	                ...
	                formatter: function (cellvalue, options, rowObject) {
	                    return "<div id='loader' style='display:none'>deleting..</div><img src='/PGCL_WEB/resources/images/delete_16.png' id='deleteBtn' alt='reject' style='cursor:pointer;' onclick=\"deleteBankTransaction("+rowObject.trans_id+")\" />";
	                }
            	}
