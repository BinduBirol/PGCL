var fields=["old_full_name","old_father_name","old_mother_name","old_gender","old_mobile","old_phone","old_fax","old_national_id","old_passport_no"];
var old_customer_fields=fields.slice();

var newFields=["full_name","father_name","mother_name","gender","mobile","phone","fax","national_id","passport_no"];
...
$("#ownership_change_history_grid").jqGrid($.extend(true, {}, scrollPagerGridOptions, {
   ...
   colNames: ['Customer Id', 'Customer Name','Father/Husband Name','Category', 'Mobile','Date'],
   colModel: [{
		       name: 'customer_id',
		       index: 'customer_id',
		       width:70,
