...
$("#bill_grid").jqGrid($.extend(true, {}, scrollPagerGridOptions, {
	url: jsEnum.GRID_RECORED_FETCHER+'?service=org.pgcl.models.BillingService&method=getNonMeteredBilledCustomerList'+'&extraFilter=area',
   	jsonReader: {
            repeatitems: false,
            id: "bill_id"
	},
...
function valiateFields(){
	 ...
	 if(isValid==true)
	 	isValid=validateField("billing_month","billing_year","bill_generation_date");
