...
$("#customer_ledger_grid").jqGrid($.extend(true, {}, scrollPagerGridOptions, {
    ...
    colNames: ['Date','Particulars', 'Sales(Tk.)', 'Collection(Tk.)','Balance(Tk.)'],
    colModel: [{
	...
	height: $("#wizard").height()-250,
	width: $("#sw-basic-step-5").width()/2,
...
$("#deposit_ledger_grid").jqGrid($.extend(true, {}, scrollPagerGridOptions, {
    ...
    colNames: ['Date','Transaction ID','Description', 'Security(Tk.)','Debit(Tk.)','Credit(Tk.)','Balance(Tk.)'],
    colModel: [{
	                name: 'deposit_date',
	                index: 'deposit_date',
	                width:50,
	...
	height: $("#wizard").height()-250,
	width: ($("#sw-basic-step-5").width()/2)-60,
