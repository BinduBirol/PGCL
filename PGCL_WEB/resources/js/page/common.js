var ajax_load="<img src='/PGCL_WEB/resources/images/loading/loading.gif' alt='loading...' />";
            ...
            success: function(data, status) {
                if (data == 'Not a Valid type') {
                    ...
                    if (navigator.appName == 'Opera') {
                        ...
                        document.getElementById('customer_photo').innerHTML = "<img src='/PGCL_WEB/"+data+"' />";
                    } else {
                        document.getElementById('customer_photo').innerHTML = "";
                        document.getElementById('customer_photo').innerHTML = "<img src='/PGCL_WEB/"+data+"' />";
                        //document.getElementById('customer_photo').src = "/PGCL_WEB/" + data + "";
                    }
                }
...
var cCategory="01:Domestic (PVT.);02:Domestic (GOVT.);03:Commercial (PVT.);04:Commercial (GOVT.);05:Industrial (PVT.);06:Industrial (GOVT.);07:Captive (PVT.);08:Captive (GOVT.);09:C.N.G (PVT.);10:C.N.G (GOVT.);11:Power (PVT.);12:Power (GOVT.);13:Fertilizer (PVT.);14:Fertilizer (GOVT.);15:Seasonal (PVT.);16:Seasonal (GOVT.);17:Tea State (PVT.);18:Tea State (GOVT.)";  //Customer Category
